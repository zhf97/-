python -u /home/wangjiawei/models/slim/txy/train_image_classifier.py \
  --dataset_name=mcookie_green\
  --dataset_dir=/home/wangjiawei/models/slim/All_colors_dataset/green \
  ...
  --train_dir=/home/wangjiawei/models/slim/All_colors_train/green \
  --learning_rate=0.001 \
